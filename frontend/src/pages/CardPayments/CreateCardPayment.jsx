      ...
      <div className="bg-gray-300 rounded-lg bg-opacity-88 p-4 w-[800px]">
        ...
        {/* <label className='text-x1 mr-4 text-black'>NIC</label>
            &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;
                    ...
                    /><br/><br/> */}
        <label className="text-x1 mr-4 text-black">Card Holder Name</label>
        &ensp;
        <input
          type="text"
        ...
        <div className="flex justify-center">
          <button
            className="bg-orange-500 hover:bg-orange-600 text-black border border-black hover:border-black px-4 py-2 rounded-full w-[100px] font-bold"
